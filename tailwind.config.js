...
module.exports = {
	...
	theme: {
		extend: {
			...
			animation: {
				slideInUp: "slideInUp .3s ease-in",
				slideInDown: "slideInDown .3s ease-out",
				scaleOut: "scaleOut .3s ease-out",
				slideRight: "slideRight .3s ease-out",
				slideLeft: "slideLeft .3s ease-out",
				slideBlur: "slideBlur .3s  ease-in .3s forwards",
